...
class ExplorationModel(object):
    def __init__(
        ...
        """
        Creates the exploration model for the Curiosity reward Generator
        ...
        :param learning_rate: The learning rate for the exploration module
        """
        self.encoding_size = encoding_size
        self.policy_model = policy_model
        self.next_visual_in: List[tf.Tensor] = []
        encoded_state, encoded_next_state = self.create_exploration_encoders()
        self.create_inverse_model(encoded_state, encoded_next_state)
        self.create_forward_model(encoded_state, encoded_next_state)
        self.create_loss(learning_rate)

    def create_exploration_encoders(self) -> Tuple[tf.Tensor, tf.Tensor]:
        """
        ...
        if self.policy_model.vis_obs_size > 0:
            ...
            for i in range(self.policy_model.vis_obs_size):
                ...
                next_visual_input = LearningModel.create_visual_input(
                    ...
                    name="exploration_next_visual_observation_" + str(i),
                )
                ...
                encoded_visual = self.policy_model.create_visual_observation_encoder(
                    ...
                    LearningModel.swish,
                    1,
                    "exploration_stream_{}_visual_obs_encoder".format(i),
                    False,
                )
        ...
        if self.policy_model.vec_obs_size > 0:
            ...
            self.next_vector_in = tf.placeholder(
                ...
                dtype=tf.float32,
                name="exploration_next_vector_observation",
            )
            ...
            encoded_vector_obs = self.policy_model.create_vector_observation_encoder(
                ...
                LearningModel.swish,
                2,
                "exploration_vector_obs_encoder",
                False,
            )
