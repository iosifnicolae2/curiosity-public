...
from mlagents.trainers.components.reward_signals.explorer.model import ExplorationModel
from mlagents.trainers.tf_policy import TFPolicy
from mlagents.trainers.models import LearningModel


class ExplorationRewardSignal(RewardSignal):
    def __init__(
        self,
        policy: TFPolicy,
        ...
        """
        Creates the Exploration reward generator
        ...
        self.model = ExplorationModel(
            policy_model, encoding_size=encoding_size, learning_rate=learning_rate
        )
        self.use_terminal_states = False
        self.update_dict = {
            "exploration_forward_loss": self.model.forward_loss,
            "exploration_inverse_loss": self.model.inverse_loss,
            "exploration_update": self.model.update_batch,
        }
        self.stats_name_to_update_name = {
            "Losses/Curiosity Forward Loss": "exploration_forward_loss",
            "Losses/Curiosity Inverse Loss": "exploration_inverse_loss",
        }
